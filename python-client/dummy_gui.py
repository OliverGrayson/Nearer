...
thumbnail_img = load_tk_image("assets/placeholder_thumb.png", max_width=300)
...
title = Label(main_box, text="No Song Playing", font="Helvetica 24")
...
connection_status = Label(connection_frame, text="☒", font="Helvetica 32", foreground="red") # ☑, green
...
connection_status.grid(row=0, column=0, padx=5)
reconnect_button.grid(row=0, column=1, padx=5)
...
for widget in all_children(root):
    if isinstance(widget, Button):
        widget.configure(padx=10, pady=10)
